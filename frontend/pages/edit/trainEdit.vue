	...
	<view class="infoEditContainer">
		...
		<view class="studentInfo">
			<u--form labelPosition="left" :model="model1" :rules="rules" ref="uForm">
				<u-form-item label="名称" prop="achievementInfo.name" borderBottom ref="item1" label-width="100px">
					<u--input v-model="achievementInfo.name" border="none" placeholder="请输入"></u--input>
				</u-form-item>
				<u-form-item label="参加时间" prop="achievementInfo.dateValue" borderBottom ref="item1" label-width="100px">
				...
				<u-form-item label="举办单位" prop="achievementInfo.awardUnit" borderBottom ref="item1" label-width="100px">
...
<script>
	export default {
		...
		onLoad: function(option) {
			...
			// 接收上级页面传递的数据
			eventChannel.on('updateTrain', (data) => {
